...
async function SendOfferEmail(to, url, text, name) {
  try {
    ...
    let info = await transporter.sendMail({
      ...
      subject: "New Offer Available!", // Subject line
      html: `
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
      ...
      <div class="container">
        <div class="wrapper">
          <div class="card">
            ...
            <h1>New Offer in ${newOffer.shopName}</h1>
            <p>We have a new offer for you! ${newOffer.offerTitle}: ${newOffer.offerContent}</p>
